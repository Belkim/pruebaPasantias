                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="edad" type="text" class="form-control @error('edad') is-invalid @enderror" name="edad" value="{{ old('edad') }}" required autocomplete="18">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="fotom" type="text" class="form-control" name="foto" required>
                            </div>
                        </div>
